...
// https://github.com/tadas-s/isbnjs/blob/master/isbn.js
(function () {
  'use strict';
  ...
  var ISBN = {
    ...
    GROUPS: {
      ...
      '978-602': {
        name: 'Indonesia',
        ranges: [['00', '07'], ['0800', '0899'], ['0900', '1099'], ['1100', '1199'], ['1200', '1399'], ['14000', '14999'], ['1500', '1699'], ['17000', '17999'], ['18000', '18999'], ['19000', '19999'], ['200', '619'], ['6200', '6749'], ['6750', '6999'], ['70000', '74999'], ['7500', '7999'], ['8000', '9499'], ['95000', '99999']]
      },
      '978-603': {
        name: 'Saudi Arabia',
      ...
      '978-605': {
        name: 'Turkey',
        ranges: [['01', '02'], ['030', '039'], ['04', '09'], ['100', '399'], ['4000', '5999'], ['60000', '89999'], ['9000', '9999']]
      },
      '978-606': {
        name: 'Romania',
        ranges: [['0', '0'], ['10', '49'], ['500', '799'], ['8000', '9099'], ['910', '919'], ['92000', '97499'], ['975', '999']]
      },
      '978-607': {
        name: 'Mexico',
      ...
      '978-85': {
        name: 'Brazil',
        ranges: [['00', '19'], ['200', '549'], ['5500', '5999'], ['60000', '69999'], ['7000', '8499'], ['85000', '89999'], ['900000', '924999'], ['92500', '94499'], ['9450', '9599'], ['96', '97'], ['98000', '99999']]
      },
      '978-86': {
      ...
      '978-955': {
        name: 'Sri Lanka',
        ranges: [['0000', '1999'], ['20', '38'], ['3900', '4099'], ['41000', '43999'], ['44000', '44999'], ['4500', '4999'], ['50000', '54999'], ['550', '749'], ['7500', '7999'], ['8000', '9499'], ['95000', '99999']]
      },
      '978-956': {
        name: 'Chile',
      ...
      '978-967': {
        name: 'Malaysia',
        ranges: [['00', '00'], ['0100', '0999'], ['10000', '19999'], ['2000', '2499'], ['300', '499'], ['5000', '5999'], ['60', '89'], ['900', '989'], ['9900', '9989'], ['99900', '99999']]
      },
      '978-968': {
        name: 'Mexico',
      ...
      '978-969': {
        name: 'Pakistan',
        ranges: [['0', '1'], ['20', '22'], ['23000', '23999'], ['24', '39'], ['400', '749'], ['7500', '9999']]
      },
      '978-970': {
        name: 'Mexico',
      ...
      '978-981': {
        name: 'Singapore',
        ranges: [['00', '16'], ['17000', '19999'], ['200', '299'], ['3000', '3099'], ['310', '399'], ['4000', '9999']]
      },
      '978-982': {
        name: 'South Pacific',
      ...
      '978-987': {
        name: 'Argentina',
        ranges: [['00', '09'], ['1000', '1999'], ['20000', '29999'], ['30', '35'], ['3600', '3999'], ['4000', '4199'], ['42', '43'], ['4400', '4499'], ['45000', '48999'], ['4900', '4999'], ['500', '899'], ['9000', '9499'], ['95000', '99999']]
      },
      '978-988': {
        name: 'Hong Kong, China',
        ranges: [['00', '11'], ['12000', '14999'], ['15000', '16999'], ['17000', '19999'], ['200', '769'], ['77000', '79999'], ['8000', '9699'], ['97000', '99999']]
      },
      '978-989': {
        name: 'Portugal',
        ranges: [['0', '1'], ['20', '54'], ['550', '799'], ['8000', '9499'], ['95000', '99999']]
      ...
      '978-9957': {
        name: 'Jordan',
        ranges: [['00', '39'], ['400', '649'], ['65', '69'], ['70', '84'], ['8500', '8799'], ['88', '99']]
      },
      '978-9958': {
        name: 'Bosnia and Herzegovina',
      ...
      '978-9974': {
        name: 'Uruguay',
        ranges: [['0', '2'], ['30', '54'], ['550', '749'], ['7500', '9099'], ['91', '94'], ['95', '99']]
      },
      '978-9975': {
        name: 'Moldova',
    ...
    parse: function parse(val, groups) {
  ...
  ISBN.isbn.prototype = {
    ...
    parse: function parse(val) {
      var ret; // Coerce ISBN to string

      val += ''; // Correct for misplaced hyphens
      // val = val.replace(/ -/,'');

      ret = val.match(/^\d{9}[\dX]$/) ? this.fill(this.merge({
        source: val,
        isValid: true,
        isIsbn10: true,
        isIsbn13: false
      }, this.split(val))) : val.length === 13 && val.match(/^(\d+)-(\d+)-(\d+)-([\dX])$/) ? this.fill({
        source: val,
        isValid: true,
        isIsbn10: true,
        isIsbn13: false,
        ...
        article: RegExp.$3,
        check: RegExp.$4
      }) : val.match(/^(978|979)(\d{9}[\dX]$)/) ? this.fill(this.merge({
        source: val,
        isValid: true,
        isIsbn10: false,
        isIsbn13: true,
        prefix: RegExp.$1
      }, this.split(RegExp.$1 + RegExp.$2))) : val.length === 17 && val.match(/^(978|979)-(\d+)-(\d+)-(\d+)-([\dX])$/) ? this.fill({
        source: val,
        isValid: true,
        isIsbn10: false,
        isIsbn13: true,
    ...
    splitToArray: function splitToArray(isbn13) {
      var rec;
      var key;
      var rest;
      var i;
    ...
    splitToObject: function splitToObject(isbn13) {
    ...
    fill: function fill(codes) {
      ...
      ck10 = this.calcCheckDigit([codes.group, codes.publisher, codes.article].join(''));
    ...
    getGroupRecord: function getGroupRecord(isbn13) {
      var key;
    ...
    calcCheckDigit: function calcCheckDigit(isbn) {
      var c;
      var n;
  ...
  var exports = (typeof window === "undefined" ? "undefined" : _typeof(window)) === 'object' && window ? window : module.exports;
  exports.ISBN = ISBN;
})();
...
if (!isMochaRunning(global)) {
  ...
  (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regeneratorRuntime["default"].mark(function _callee() {
    var output;
...
function isbnInfo(_x, _x2) {
  return _isbnInfo.apply(this, arguments);
}

function _isbnInfo() {
  _isbnInfo = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regeneratorRuntime["default"].mark(function _callee2(input, OPTIONS) {
